...
$allservers = Get-DbaCmsRegServer -SqlInstance sql2014
...
# db space
Get-DbaDbSpace -SqlInstance $old -IncludeSystemDBs | Out-GridView
...
# Database clone
Invoke-DbaDbClone -SqlInstance sql2017 -Database clonemebaw -CloneDatabase clonemebaw_clone
