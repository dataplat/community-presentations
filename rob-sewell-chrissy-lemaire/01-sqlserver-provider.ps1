...
Get-ChildItem SQLSERVER:\SQL\ROB-SURFACEBOOK\DEFAULT
Get-ChildItem SQLSERVER:\SQL\ROB-SURFACEBOOK\DAVE
...
RESTORE DATABASE [ProviderDemo] FROM DISK = N'C:\MSSQL\Backup\ProviderDemo.bak' 
WITH  MOVE N'ProviderDemo' TO N'C:\MSSQL\Data\ProviderDemo.mdf',  
MOVE N'ProviderDemo_Log' TO N'C:\MSSQL\Logs\ProviderDemo.ldf',  
...
## SQL Community User Voice - about the https://sqlps.io/voteas  XXX get the correct URL
