...
Invoke-DbaQuery -ServerInstance $singleServer -Query "IF EXISTS (SELECT 1 FROM sys.databases WHERE name = 'AutoGrowth')
BEGIN
...
"@
Invoke-DbaQuery -ServerInstance $singleServer -Query $queryConfigureDatabase
...
WHILE (@Iteration < 2000)
	...
	END
"@
Invoke-DbaQuery -ServerInstance $singleServer -Query $queryForceAutoGrowthEvents -Database AutoGrowth
...
"@
Invoke-DbaQuery -ServerInstance ROB-XPS -Database AdventureWorks2014 -query $query
