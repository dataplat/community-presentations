...
Invoke-DbaQuery -ServerInstance $centralServer -Query "CREATE DATABASE [$centralDB]"
...
#>
Write-Output "Will run Test-DbaDbRecoveryModel" 
$DbaFullRecoveryModel = Test-DbaDbRecoveryModel -SqlServer $serverList -SqlCredential $SqlCredential -Detailed -Verbose | ConvertTo-DbaDataTable
